      ...
      <div className="max-w-md mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#6B7280]">Logg inn som kunde</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#17384E] text-white rounded-lg font-semibold hover:bg-[#1a4459] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-xs text-blue-800 mb-2">
            Bruk disse testkontoene, eller opprett ny bruker via Admin Panel:
          </p>
