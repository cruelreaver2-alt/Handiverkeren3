...
import { ArrowLeft, Plus, X, Send, Clock, Package, FileText, Award } from "lucide-react";
...
export function MediumOfferBuilder() {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-[#E07B3E]/10 border border-[#E07B3E]/30 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            <Award className="w-5 h-5 text-[#E07B3E] flex-shrink-0 mt-0.5" />
            <div>
              <h3 className="font-semibold text-[#111827] mb-1">
                Standard tilbudsbygger (Medium)
              </h3>
              <p className="text-sm text-[#6B7280]">
                Du bruker Medium-planen. Oppgrader til Pro for tilgang til materialdatabase og avanserte kalkulatorer.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6">
          ...
          {/* Additional Terms (Medium feature) */}
          <div className="bg-white rounded-lg border border-[#E5E7EB] p-6">
            <div className="flex items-center gap-2 mb-4">
              <FileText className="w-5 h-5 text-[#E07B3E]" />
              <h2 className="text-lg font-bold text-[#111827]">Tilleggsvilkår</h2>
            </div>
            ...
            <div>
              ...
              <textarea
                placeholder="Eventuelle merknader eller spesialvilkår..."
                value={customerNotes}
                onChange={(e) => setCustomerNotes(e.target.value)}
                className="w-full h-24 px-4 py-3 border border-[#E5E7EB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#17384E] resize-none"
              />
            </div>
            ...
            <div className="mt-4">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-sm text-[#111827]">
                  Inkluder bilder fra portefølje i tilbudet
                </span>
              </label>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-[#E5E7EB] p-6">
            ...
            {warranty && (
              <div className="mt-4 p-3 bg-[#E07B3E]/10 rounded-lg">
                <div className="flex items-center gap-2 text-sm">
                  <Award className="w-4 h-4 text-[#E07B3E]" />
                  <span className="text-[#111827]">
                    <strong>{warranty} år</strong> garanti på utført arbeid
                  </span>
                </div>
              </div>
            )}
